...
| branch_select (PH) | S25 Form 5 per-target physics sign closed at 0.14x MDE | Form 5 switched near-identical arms (corr 0.95); the projection branches differ up to 1.6 A -- a genuinely different discrete choice | 0.20 |
