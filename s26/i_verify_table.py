...
READING = {
    ...
    "project_stability": "IDENTICAL on every science leaf (469/469): the reference against itself under a rigid motion on the same 77 targets reproduces the tracked partial exactly (d(arm) median 0.0323 A, worst 1.6246 A, |dfval| max 0.0890, 62 / 46 / 18 targets moved by more than 1e-3 / 0.01 / 0.1 A); the 2 different leaves and 1 removed leaf are bookkeeping: the tracked file was a run of 126 stopped by the RAM gate at 77 (`stopped_by`, `complete: false`, `requested: 126`), the fresh one was asked for 77 and completed",
