...
def load_values():
    ...
    put("CORPUS_PEPTIDES", int(pe["n_peptides"]), "s26/results/p_probe_esm.json :: n_peptides", note="ledger L11")
    put("CORPUS_FRAGMENTS", int(pe["n_fragments"]), "s26/results/p_probe_esm.json :: n_fragments", note="ledger L11; n_train_seqs_unique 6,790")
