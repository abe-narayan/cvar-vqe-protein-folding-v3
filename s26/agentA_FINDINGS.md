...
| 8 | A1: ADAPT is null, -0.014 / -0.022 A at 0.23x / 0.36x MDE | NOT MEASURED on two seeds (seed 1: -0.045 / -0.052 at 0.71x / 0.79x, Type-M); the deployed circuit moves 0.033 A between seeds, the grown circuits 0.002 (L139, L140); the comparison resolves 0.06 A; "twelve of twelve arms negative" is one observation (pairwise correlation 0.955); the 21-parameter match is a budget with realised counts 7 to 21; growth at alpha = 1 is inert, not absent (L75) | L70, L75, L82 |
