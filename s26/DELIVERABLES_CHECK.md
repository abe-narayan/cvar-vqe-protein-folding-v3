...
| 8 | LEDGER + RETRACTIONS | OK | 137 entries, append-only, collisions suffixed; `RETRACTIONS.md` R1-R11 plus the prior-sprint disposition table (R2 the depth-3 scope; the S13 Pauli weights sourcing gap; S7-11 -0.288 replaced by L62; S10-4 re-derived; the suite's basis; S16 sharpened; routers extended; L38 scoped by L89) | -- |
...
- A1: "twelve of twelve" is one observation (corr 0.955); NOT MEASURED on two seeds (0.23x / 0.36x at seed 0, 0.71x / 0.79x Type-M at seed 1); the deployed fixed circuit moves 0.033 A between seeds (3.228 / 3.261) while the grown circuits are seed-stable; growth at alpha = 1 is inert, not absent (L70, L75, L82, L139, L140). Slide 4's 3.2148 is seed-free.
