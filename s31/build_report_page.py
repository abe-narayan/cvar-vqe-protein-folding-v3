#!/usr/bin/env python
"""s31/build_report_page.py -- rebuild the published S31 report page.

Injects `s31/REPORT_S31.md` verbatim into the template `s31/report_page.html` and writes the
...
Published 2026-09-21 at https://claude.ai/artifact/BJ6WTXG3cjtq5jQ95LqgSS

    python s31/build_report_page.py [out.html]
"""
...
def main():
    out = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "REPORT_S31_page.html")
    md = io.open(os.path.join(HERE, "REPORT_S31.md"), encoding="utf-8").read()
